  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        window.location.href = isAdmin ? "/desktop-admin" : "/desktop-data";
      ...
      <div className="frame-50">
        ...
        <div className="hero-7">
          <div className="frame-52">
           <div className="text-wrapper-34">{isAdmin ? "Sign In - Admin" : "Sign In"}</div>
            {errorMsg && <p className="error-message">{errorMsg}</p>}
            <form onSubmit={handleSubmit}>
              <div className="frame-52">
               <div className="text-wrapper-35">{isAdmin ? "Admin Email" : "Employee Email"}</div>
